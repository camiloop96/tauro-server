...
exports.DetailBranchStoreUseCase = void 0;
const AppError_1 = require("../../../../shared/errors/AppError");
class DetailBranchStoreUseCase {
    ...
    execute(branchStoreID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Get Detail
            const detailBranchStore = yield this.branchStoreRepository.detailBranchStore(checkedAndParsedID);
            // return
...
exports.DetailBranchStoreUseCase = DetailBranchStoreUseCase;
