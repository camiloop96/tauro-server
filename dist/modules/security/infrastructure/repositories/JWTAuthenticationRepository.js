...
exports.JWTAuthenticationRepository = void 0;
    ...
    decodeToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!tokenDecoded) {
                    throw new AppError_1.AppError("Authorization token invalid", 400);
                }
                return tokenDecoded;
            }
            catch (error) {
                if (error instanceof AppError_1.AppError) {
                    ...
                    throw new AppError_1.AppError("Error decoding token", 500);
                }
            }
        });
    }
...
exports.JWTAuthenticationRepository = JWTAuthenticationRepository;
