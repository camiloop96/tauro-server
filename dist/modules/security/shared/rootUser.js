...
const CredentialModel_1 = __importDefault(require("../infrastructure/models/CredentialModel"));
...
const createRootUser = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        let existingRole = yield RoleModel_1.default.exists({
            name: rolMaster,
        });
        let idRole;
        if (!existingRole) {
            idRole = new RoleModel_1.default({
                name: rolMaster,
            });
            idRole.save();
            ...
            idRole = yield RoleModel_1.default.findOne({
                name: rolMaster,
            });
        }
